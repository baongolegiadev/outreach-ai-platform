...
- [ ] #001 — Scaffold pnpm monorepo (apps/web Next.js, apps/api NestJS, shared tooling, root scripts) [area: setup] → [.tasks/001-monorepo-scaffold.md](.tasks/001-monorepo-scaffold.md)
